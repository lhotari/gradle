...
"""
    ...
    private GradleExecuter daemonExecutor() {
        ...
        targetDist.executer(temporaryFolder).withDaemonBaseDir(toolingApi.daemonBaseDir).withBuildJvmOpts("-Xmx1536m", "-XX:MaxPermSize=256m", "-XX:+HeapDumpOnOutOfMemoryError").useDefaultBuildJvmArgs().requireDaemon()
    }
}
