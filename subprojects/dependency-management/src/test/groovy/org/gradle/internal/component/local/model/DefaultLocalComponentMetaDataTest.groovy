...
class DefaultLocalComponentMetaDataTest extends Specification {
    ...
    def addArtifact(String configuration, PublishArtifact publishArtifact) {
        metaData.addArtifacts(configuration, new DefaultPublishArtifactSet("arts", WrapUtil.toDomainObjectSet(PublishArtifact, publishArtifact), TestFiles.resolver().getPatternSetFactory()))
    }
