...
import org.gradle.internal.classloader.MissingClassCachingClassLoader;
...
public class ProcessBootstrap {
    ...
    private void runNoExit(String mainClassName, String[] args) throws Exception {
        ...
        ClassLoader runtimeClassLoader = new MissingClassCachingClassLoader(new MutableURLClassLoader(antClassLoader, runtimeClasspath));
