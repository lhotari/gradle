...
public class BuildExperimentRunner {
    ...
    private void runOnce(final GradleSession session, final BuildExperimentSpec experiment, MeasuredOperationList results, final Phase phase, final int iterationNumber, final int iterationMax) {
