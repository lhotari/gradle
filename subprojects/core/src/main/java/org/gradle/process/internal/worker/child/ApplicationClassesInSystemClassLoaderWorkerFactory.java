...
public class ApplicationClassesInSystemClassLoaderWorkerFactory implements WorkerFactory {
    ...
    private final JavaExecutableVersionProber versionChecker = new CachedJavaExecutableVersionProber(new DefaultJavaExecutableVersionProber());
    ...
    private boolean shouldUseOptionsFile(JavaExecHandleBuilder execSpec) {
        JavaVersion executableVersion = versionChecker.probeVersion(execSpec);
