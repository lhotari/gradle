...
public class GradleScopeServices extends DefaultServiceRegistry {
    ...
    TreeVisitorCacheExpirationStrategy createTreeVisitorCacheExpirationStrategy(CachingTreeVisitor cachingTreeVisitor, Gradle gradle) {
        return new TreeVisitorCacheExpirationStrategy(cachingTreeVisitor, new Factory<OverlappingDirectoriesDetector>() {
            @Override
