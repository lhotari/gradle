...
public class TaskUpToDateState {
    ...
    public TaskUpToDateState(final TaskInternal task, TaskHistoryRepository.History history, final FileCollectionSnapshotter outputFilesSnapshotter, final FileCollectionSnapshotter inputFilesSnapshotter) {
        ...
        createInputFilesState(task, outputFilesSnapshotter, inputFilesSnapshotter, thisExecution, lastExecution);
    ...
    private void createInputFilesState(TaskInternal task, FileCollectionSnapshotter outputFilesSnapshotter, final FileCollectionSnapshotter inputFilesSnapshotter, final TaskExecution thisExecution, final TaskExecution lastExecution) {
        // Capture inputs state
        try {
            final FileCollectionSnapshotter.FileCollectionPreCheck inputFilesPrecheckBefore = outputFilesSnapshotter.preCheck(task.getInputs().getFiles());
    ...
    private void createOutputFilesState(final TaskInternal task, final FileCollectionSnapshotter outputFilesSnapshotter, final TaskExecution thisExecution, final TaskExecution lastExecution) {
        ...
        try {
            final FileCollectionSnapshotter.FileCollectionPreCheck outputFilesPrecheckBefore = outputFilesSnapshotter.preCheck(task.getOutputs().getFiles());
