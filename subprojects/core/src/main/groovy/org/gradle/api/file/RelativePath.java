...
public class RelativePath implements Serializable, Comparable<RelativePath> {
    ...
    private static final String FILE_PATH_SEPARATORS = "/" + File.separator;
    ...
    public static RelativePath parse(boolean isFile, RelativePath parent, String path) {
        String[] names = File.separatorChar != '/' ? StringUtils.split(path, FILE_PATH_SEPARATORS) : StringUtils.split(path, File.separatorChar);
