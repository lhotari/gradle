...
class InputFilesStateChangeRule {
    public static InputFilesTaskStateChanges create(final TaskExecution previousExecution, final TaskExecution currentExecution, final FileCollectionSnapshotter inputFilesSnapshotter, final FileCollectionSnapshotter.FileCollectionPreCheck inputFilesPrecheckBefore) {
    ...
    static class InputFilesTaskStateChanges implements TaskStateChanges {
        ...
        private final FileCollectionSnapshotter.FileCollectionPreCheck inputFilesPrecheckBefore;
        private FileCollectionSnapshot inputFilesSnapshot;

        private InputFilesTaskStateChanges(TaskExecution previousExecution, TaskExecution currentExecution, FileCollectionSnapshotter inputFilesSnapshotter, FileCollectionSnapshotter.FileCollectionPreCheck inputFilesPrecheckBefore) {
