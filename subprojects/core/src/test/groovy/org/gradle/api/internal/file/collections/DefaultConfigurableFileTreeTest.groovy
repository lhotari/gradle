...
class DefaultConfigurableFileTreeTest extends AbstractTestForPatternSet {
    ...
    FileResolver fileResolverStub = [resolve: { it as File }, getPatternSetFactory: { TestFiles.resolver().getPatternSetFactory() }] as FileResolver
    ...
    public void canGetAndSetTaskDependencies() {
        ...
        context.checking {
            DefaultConfigurableFileCollectionTest.addGetPatternSetFactory(delegate, fileResolverStub)
        }
        fileSet = new DefaultConfigurableFileTree(testDir, fileResolverStub, taskResolverStub, fileCopier)
